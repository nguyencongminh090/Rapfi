...
enum GenType {
  ...
  COMB = 8, // Move must be a conbination pattern type
  ...
  DEFEND_FIVE = 512,  // Only generate A_FIVE defence move
  DEFEND_FOUR = 1024, // Only generate B_FLEX4 defence move
  DEFEND_B4F3 = 2048, // Only generate C_BLOCK4_FLEX3 defence move
...
struct ScoredMove {
  Pos pos;
  Score score; /// Score with history and other heruistics that is used for
               /// sorting
  union {
