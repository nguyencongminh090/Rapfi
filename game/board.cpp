...
void Board::setBlock(Pos pos)
{
    ...
    if (oldPiece == EMPTY) {
        ...
        // So, to clear BLACK piece (10b), we must flip WHITE: flipBitKey(pos, WHITE)
        // To clear WHITE piece (01b), we must flip BLACK: flipBitKey(pos, BLACK)
